...
import { ArrowRight, Mail, Linkedin, Twitter, Globe } from "lucide-react";
                            ...
                            <div className="flex gap-6">
                                ...
                                <div className="space-y-4 font-mono text-xs flex-1">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className="flex items-center gap-2 font-bold text-[#F35815]">
                                            <span className="relative flex h-2 w-2">
                                                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#F35815] opacity-75"></span>
                                                <span className="relative inline-flex rounded-full h-2 w-2 bg-[#F35815]"></span>
                                            </span>
                                            AVAILABLE Q1
                                        </div>
                                    </div>
