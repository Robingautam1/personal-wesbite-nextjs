...
const SystemStatusTicker = () => {
    const statuses = [
        { label: "Cash Curious", status: "LIVE", color: "text-emerald-600" },
        { label: "Comex Digital", status: "REFACTORING", color: "text-yellow-600" },
        { label: "System Core", status: "ONLINE", color: "text-[#F35815]" },
...
export default function DesktopExperience() {
    ...
    return (
        <div className="bg-[#F4F3EE] min-h-screen text-black selection:bg-[#F35815] selection:text-white font-sans overflow-x-hidden">
            ...
            {/* HERO SECTION - REVERTED TO BLACK AS REQUESTED */}
            <header className="pt-32 pb-20 md:pt-48 md:pb-32 px-4 md:px-6 border-b border-black/10 overflow-hidden relative bg-brand-black text-white">
                {/* Background Grid Pattern (Inverted for Dark Mode) */}
                ...
                <div className="max-w-[1400px] mx-auto grid lg:grid-cols-[1.5fr_1fr] gap-16 items-end relative z-10">
                    ...
                    <div>
                        <motion.h1
                            ...
                            className="text-5xl sm:text-6xl md:text-8xl lg:text-[7rem] font-bold leading-[0.9] tracking-tighter mb-8 break-words max-w-full text-white"
                        >
                            WE BUILD <br />
                            <span className="text-[#F35815] drop-shadow-[0_0_15px_rgba(243,88,21,0.5)]">SH*T</span> THAT <br />
                            <span className="text-white font-black tracking-tighter">SLAPS.</span>
                        </motion.h1>
                        ...
                        <div className="flex flex-wrap gap-4 mt-12">
                            <Link
                                href="/portfolio"
                                className="px-6 py-3 md:px-8 md:py-4 bg-white text-black font-bold uppercase tracking-widest hover:bg-[#F35815] transition-colors text-sm md:text-base border-2 border-transparent hover:border-black"
                            >
                                View Latest Work
                            </Link>
                            <button
                    ...
                    {/* Right: System Status - Dark Mode Variant */}
                    <motion.div
                    ...
                    >
                        ...
                        <div className="mt-8 pt-6 border-t border-white/10 bg-white/5 -mx-8 -mb-8 p-8">
                            ...
                            <p className="font-mono text-xs md:text-sm text-white break-words whitespace-normal font-medium">983e2cf - Revert "Pivot to High-Impact Portfolio"</p>
                        </div>
                    </motion.div>
                </div>
            </header>
            ...
            {/* DEMOS SECTION (The Lab) - LIGHT MODE COMPATIBLE */}
            <DemosSection />
